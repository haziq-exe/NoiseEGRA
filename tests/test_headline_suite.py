...
st, _ = build_suite("steering", VECS, LAYERS, list(NAMES), RMS, types.SimpleNamespace(**BASE))
rb, _ = build_suite("randombase", VECS, LAYERS, list(NAMES), RMS, types.SimpleNamespace(**BASE))
