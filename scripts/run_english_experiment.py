...
def main() -> None:
    ...
    ap.add_argument("--suite", nargs="+", default=["compare"],
                    choices=["baseline", "sampling", "compare", "method", "noise",
                             ...
                             "beta", "loo", "colour", "colourfront", "wholefive", "wholeloop", "randomfisher", "randomvariants", "randomnext", "randombase", "randomfixed", "randomshadow", "randomloop", "randomsplit", "randomfront", "randomprompt", "randomstory", "all"])
    ...
    ap.add_argument("--prompt-gains", type=float, nargs="+", default=[1.0, 1.5, 2.0],
                    help="suite 'randomstory': multiples of the noise on the prompt")
    ap.add_argument("--prompt-gain", type=float, default=2.0,
                    help="suite 'randomprompt': the multiple of the noise on the prompt")
    ap.add_argument("--prompt-fade-to", type=float, default=0.25,
                    help="suite 'randomprompt': share of it left at the prompt's end")
    ap.add_argument("--front-gains", type=float, nargs="+", default=[1.5, 2.0],
                    help="suite 'randomfront': the multiples the noise starts at")
    ap.add_argument("--front-tokens", type=int, default=40,
                    help="suite 'randomfront': tokens over which it falls back")
