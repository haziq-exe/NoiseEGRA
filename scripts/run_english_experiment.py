...
BASIS_SUITES = {"offset", "story", "prompt", "main", "pareto", "select", "feedback",
                ...
                "controls", "tame", "core4", "combine", "amplify", "spread", "frontier", "siting", "prefill", "asymmetric", "boundary", "bands", "whilewriting", "gatedwrite",
                "constdose"}
...
def main() -> None:
    ...
    ap.add_argument("--suite", nargs="+", default=["compare"],
                    choices=["baseline", "sampling", "compare", "method", "noise",
                             ...
                             "ablate", "controls", "tame", "fsc", "core4", "combine", "dose", "siting", "dropone", "prefill", "asymmetric", "boundary", "bands", "whilewriting", "gatedwrite",
